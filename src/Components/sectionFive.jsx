            ...
            <div className="relative">
              ...
              <h1 className="absolute left-[480px] top-16 text-[5em] opacity-10 z-0"><i class="fa-solid fa-quote-right"></i></h1>
                ...
                <div className="flex  items-center justify-between">
                    ...
                    <img className=" w-[320px]    rounded-3xl absolute right-[270px] top-[320px] z-20 h-[350px]" src={watchFront} alt="" />
                    <img className="absolute -right-40 top-16 z-0" src={shape2} alt="" />
                    </div>
        </div>

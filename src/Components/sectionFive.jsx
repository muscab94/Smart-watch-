...
import testmonial2 from "../assets/testimonial-4.jpg"
...
function SectionFive() {
  ...
  const handleTestmonial1=()=>{
    setTestmonial(true)
    setAnimState("anima4")
  }
  const handleTestmonial2=()=>{
    setTestmonial(false)
    setAnimState("anima3")
  }
  ...
  return (
    <div className="max-w-[90%] mx-auto flex justify-between px-1 py-20">
      <div className="relative">
        ...
        <div className="relative z-10">
          ...
          {/* testmonial 1 */}
          <div style={{display: testmonial===true? "none" : "block"}} className={animState==="anima3" ? "animate-anima3" : ""}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className=" flex gap-10 text-[1.5em]">
              <i className="fa-solid fa-arrow-left opacity-25 hover:text-white pr-8 hover:bg-black py-2 px-2 rounded-full  hover:opacity-100"></i>
              <i onClick={handleTestmonial1} className="fa-solid fa-arrow-right cursor-pointer opacity-25 hover:text-white hover:bg-black py-2 px-2 pr-8 rounded-full  hover:opacity-100"></i>
            </div>
          </div>
          </div>

          {/* testmonial 2 */}
          <div style={{display: testmonial===true? "block" : "none"}} className={`hidden ${animState==="anima4" ? "animate-anima4" : ""} `}>
             <h1 className="absolute left-[480px] top-16 text-[5em] opacity-10 z-0">
            <i className="fa-solid fa-quote-right"></i>
          </h1>
               <p className="text-[2em] font-extrabold pl-10 ">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-5 pt-5 items-center ml-8">
              <img className="rounded-full w-20" src={testmonial2} alt="" />
              <div>
                <h1 className="font-bold text-[1.3em]">John Carter</h1>
                <h1 className="text-gray-400">UX Designer</h1>
              </div>
            ...
            <div className="pr-16 flex gap-10 text-[1.5em]">
              <i onClick={handleTestmonial2} className="fa-solid fa-arrow-left opacity-25 hover:text-white hover:bg-black py-2 px-2 pr-8 rounded-full  hover:opacity-100"></i>
              <i className="fa-solid fa-arrow-right opacity-25 hover:text-white hover:bg-black py-2 px-2 pr-8 rounded-full  hover:opacity-100"></i>
            </div>
          </div>
          </div>
        </div>
      ...
      <div className="relative">
        ...
        <img className="absolute left-20 hidden top-16  z-0" src={shape2} alt="" />
      </div>
    </div>
  )
}

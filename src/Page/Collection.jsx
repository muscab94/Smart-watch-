  ...
  return <div className={`absolute ml-[105px] -translate-x-1/2 mt-2 transition-all duration-300 ease-in-out ${ show ? "opacity-100 visible" : "opacity-0 invisible"}`} >
      <div className="flex justify-center py-7 px-10 pb-14 bg-black rounded-3xl gap-5">
        ...
        <div className="bg-white w-[220px] h-[220px] rounded-xl relative">
          ...
          <NavLink to= "/CheckNow1"><button className="bg-blue hover:bg-black text-white py-1 px-5 rounded-3xl absolute right-14 -bottom-4"> Check Now </button></NavLink>
        </div>
        ...
        <div className="bg-white w-[220px] h-[220px] rounded-xl relative">
          ...
          <NavLink to= "/CheckNow2"><button className="bg-blue hover:bg-black text-white py-1 px-5 rounded-3xl absolute right-14 -bottom-4">Check Now </button> </NavLink>
        </div>
        ...
        <div className="bg-white w-[220px] h-[220px] rounded-xl relative">
          ...
          <NavLink to= "CheckNow3"><button className="bg-blue hover:bg-black text-white py-1 px-5 rounded-3xl absolute right-14 -bottom-4"> Check Now </button></NavLink>
        </div>
        ...
        <div className="bg-white w-[220px] h-[220px] rounded-xl relative">
          ...
          <NavLink to= "CheckNow4"><button className="bg-blue hover:bg-black text-white py-1 px-5 rounded-3xl absolute right-14 -bottom-4"> Check Now </button> </NavLink>
        </div>
        ...
        <div className="bg-white w-[220px] h-[220px] rounded-xl relative">
          ...
          <NavLink to= "/CheckNow5"><button className="bg-blue hover:bg-black text-white py-1 px-5 rounded-3xl absolute right-12 -bottom-4"> Check Now </button> </NavLink>
        </div>
      </div>
    </div>
